...
ui <- navbarPage(title='Shiny Tutorial',
  tabPanel(
    'Lesson 1',
    includeMarkdown("advancedClassLesson1.md"),
    leafletOutput('mymap1'),
  ),
  tabPanel(
    'Lesson 2',
    includeMarkdown("advancedClassLesson2.md"),
    textOutput('latlon2'),
    leafletOutput('mymap2', width=600, height=600)
  ),
  tabPanel(
    'Lesson 3',
    includeMarkdown("advancedClassLesson3.md"),
    leafletOutput('mymap3', width=600, height=600),
    plotOutput('forecastPlot3')
  ),
  tabPanel(
    'Lesson 4',
    includeMarkdown("advancedClassLesson4.md"),
  ...
  tabPanel(
    'Lesson 5',
    includeMarkdown("advancedClassLesson5.md"),
    tabsetPanel(
      tabPanel(
        'Maps',
        fillPage(
  ...
  tabPanel(
    'Lesson 6',
    includeMarkdown("advancedClassLesson6.md"),
    tabsetPanel(
      # page one
      tabPanel(
        'Maps',
